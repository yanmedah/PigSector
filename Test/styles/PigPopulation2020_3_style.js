...
var style_PigPopulation2020_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Populasi B");
    var labelText = "";
    size = 0;
    ...
    if (value >= 48992.000000 && value <= 58620.200000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 58620.200000 && value <= 79956.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 79956.800000 && value <= 110984.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 110984.800000 && value <= 140062.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 140062.000000 && value <= 525445.000000) {
            style = [ new ol.style.Style({
